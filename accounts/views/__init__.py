from .generic import (
    ...
    # GenericPasswordChangeDoneView as PasswordChangeDoneView,
    # GenericPasswordResetView as PasswordResetView,
    # GenericPasswordResetDoneView as PasswordResetDoneView,
...
# from .custom import (
    ...
    # CustomPasswordChangeDoneView as PasswordChangeDoneView,
